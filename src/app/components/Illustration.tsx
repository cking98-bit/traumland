...
export default function Illustration({
  ...
  useEffect(() => {
    // Gespeichertes Bild aus localStorage laden
    if (geschichteId) {
      const gespeichert = ladeGeschichteById(geschichteId)
      if (gespeichert?.bild) {
        setBild(gespeichert.bild)
        return // Kein neu generieren nötig
      }
    }
    // Kein gespeichertes Bild → neu generieren
    erzeugen()
  }, [geschichteId])
