...
export const texte: Record<Sprache, Dict> = {
  de: {
    ...
    "gen.dauerLightHint": "Im Light-Tarif sind Geschichten bis 5 Minuten enthalten – längere gibt es im Familie-Tarif.",
  ...
  en: {
    ...
    "gen.dauerLightHint": "The Light plan includes stories up to 5 minutes – longer ones are available in the Family plan.",
